<html>
    ...
    <meta charset="utf-8">
    <link href="https://cdn.bootcss.com/flexslider/2.6.3/flexslider.min.css" rel="stylesheet">                      1.佈告欄部分：
    <script src="https://cdn.bootcss.com/jquery/2.2.2/jquery.min.js"></script>                                        在 HTML 中使用 PHP 代碼從數據庫中檢索佈告信息。
    <script src="https://cdn.bootcss.com/flexslider/2.6.3/jquery.flexslider-min.js"></script>                         佈告欄標題為「最新公告」，並包含一個表格，用於顯示佈告的編號、類型、標題、內容和發佈時間。 
    <script>                                                                                                          使用 while 循環遍歷數據庫中的每一條佈告，將其顯示在表格中。
        $(window).load(function() {                                                                                 2.PHP 代碼：
            $('.flexslider').flexslider({                                                                             使用 ,mysqli_connect() ,函數連接到數據庫。
                animation: "slide",                                                                                   使用 ,mysqli_query() ,函數執行 SQL 查詢，獲取佈告信息。
                rtl: true                                                                                             使用 ,mysqli_fetch_array(), 函數遍歷查詢結果集，獲取每一條佈告的數據。
            }); 
        });
    </script>
    <style>
